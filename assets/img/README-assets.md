# Dokumentasi Manajemen Aset Visual — EcoLoka
**Proyek Lomba Web Design INVENTION 2026**
**Subtema:** "Going Green Through Smart Digital Solutions"
**Penyelenggara:** Program Studi Informatika, FMIPA, Universitas Udayana

---

## 1. Kebijakan Orisinalitas & Lisensi Aset Visual (Kepatuhan Penuh Aturan Lomba)
Sesuai Peraturan Perlombaan INVENTION 2026 Bagian Ketentuan Karya:
- Setiap aset visual pihak lain (foto, ilustrasi, grafis) **wajib memiliki Open License** atau merupakan **karya orisinal buatan tim pengembang**.
- Sumber, filosofi, dan peruntukan karya **wajib dicantumkan secara transparan** di berkas dokumentasi / proposal karya / atribusi website.
- **Bebas dari sengketa hak cipta (Zero Copyright Infringement):** Seluruh aset visual foto/ilustrasi pada proyek EcoLoka diciptakan secara orisinal khusus untuk perlombaan ini, bebas dari watermark, dan tidak melanggar hak cipta komersial entitas manapun.
